...
<body>
    <div class="container">
        <p class="judul">Tambah Buku</p>
        <form action="{{ route('databuku.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <label for="nama_lengkap">Judul </label>
            <input type="text" name="judul" placeholder="Masukan Judul Buku"><br>

            <label for="nama_lengkap">Penulis</label>
            <input type="text" name="penulis" placeholder="Masukan Penulis Buku"><br>

            <label for="nama_lengkap">Stock</label>
            <input type="number" name="stock" placeholder="Masukan Stock buku"><br>

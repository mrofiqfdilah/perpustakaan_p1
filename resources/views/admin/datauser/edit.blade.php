...
<body>
    <div class="container">
        <p class="judul">Edit Users</p>
        <form action="{{ route('datauser.update',$user->id) }}" method="POST">
            @csrf
            @method('PUT')
            <label for="nama_lengkap">Nama Lengkap</label>
            <input type="text" name="nama_lengkap" value="{{ $user->nama_lengkap }}" placeholder="Masukan nama lengkap"><br>

            <label for="username">Username</label>
            <input type="text" name="username" value="{{ $user->username }}" placeholder="Masukan username"><br>

            <label for="email">Email</label>
            <input type="email" name="email" value="{{ $user->email }}" placeholder="Masukan email"><br>
